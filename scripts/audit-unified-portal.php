...
$expect($portal,'portal-matrix-columns','Portal не поддерживает матрицу из трёх колонок.');
$expect($portal,'portal-matrix-copyright','В Portal отсутствует длинный блок копирайта.');
