...
$expect($portalLayout,'portal-sidebar__scroll','Portal не использует отдельную прокрутку колонок.');
...
$expect($fixedShell,'grid-template-rows:auto minmax(0,1fr) auto','Неподвижная оболочка Portal не настроена.');
$expect($fixedShell,'.portal-sidebar--left','Левая колонка не прорисована.');
$expect($fixedShell,'.portal-sidebar--right','Правая колонка не прорисована.');
