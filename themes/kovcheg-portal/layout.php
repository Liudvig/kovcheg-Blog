...
$zones = [];
foreach ([
    'header.top','header.main','header.bottom','page.before','layout.left',
    'content.before','content.after','layout.right','page.after',
...
<header class="portal-header">
  ...
  <div class="portal-header__main">
    <?php if($zones['header.main']!==''):?>
      <?=$zones['header.main']?>
    <?php else:?>
      <div class="portal-brand-fallback">
        <a href="<?=e(app_url('/'))?>" aria-label="<?=e($siteName)?>">
          <img src="<?=e($logo)?>" alt="">
          <span><b><?=e($siteName)?></b><small><?=e(setting('blog_tagline','Новости · мнения · проекты'))?></small></span>
        </a>
      </div>
    <?php endif;?>
  </div>
...
<footer class="portal-footer">
  <?php if($zones['footer.top']!==''||$zones['footer.columns']!==''||$zones['footer.bottom']!==''):?>
    <?php if($zones['footer.top']!==''):?><div class="portal-footer__top"><?=$zones['footer.top']?></div><?php endif;?>
    <?php if($zones['footer.columns']!==''):?><div class="portal-footer__columns"><?=$zones['footer.columns']?></div><?php endif;?>
    <?php if($zones['footer.bottom']!==''):?><div class="portal-footer__bottom"><?=$zones['footer.bottom']?></div><?php endif;?>
  <?php else:?>
    <div class="portal-footer__fallback">
      <div><b><?=e($siteName)?></b><p><?=e(setting('blog_footer_text','Информационный сайт на KOVCHEG Blog.'))?></p></div>
      <div><span><?=e(setting('copyright','© '.date('Y').' KOVCHEG CMS'))?></span><span>Автор системы: Ланцет Семён Борисович</span></div>
    </div>
  <?php endif;?>
</footer>
